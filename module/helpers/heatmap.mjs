...
export const HEATMAP_QUICK_PRESETS = {
  ...
  viridis: {
    label: 'JOSTER.HeatmapPreset.Viridis',
    low: '#440154',
    mid: '#21918c',
    high: '#fde725',
    midValue: 4.5,
  ...
  plasma: {
    label: 'JOSTER.HeatmapPreset.Plasma',
    low: '#0d0887',
    mid: '#cc4778',
    high: '#f0f921',
    midValue: 4.5,
  ...
  inferno: {
    label: 'JOSTER.HeatmapPreset.Inferno',
    low: '#000004',
    mid: '#bb3754',
    high: '#fcffa4',
    midValue: 4.5,
  ...
  magma: {
    label: 'JOSTER.HeatmapPreset.Magma',
    low: '#000004',
    mid: '#b63679',
    high: '#fcfdbf',
    midValue: 4.5,
  ...
  cividis: {
    label: 'JOSTER.HeatmapPreset.Cividis',
    low: '#00204d',
    mid: '#7c7b78',
    high: '#ffea46',
    midValue: 4.5,
  ...
  turbo: {
    label: 'JOSTER.HeatmapPreset.Turbo',
    low: '#30123b',
    mid: '#29bf12',
    high: '#7a0403',
    midValue: 4.5,
  ...
  coolwarm: {
    label: 'JOSTER.HeatmapPreset.Coolwarm',
    low: '#3b4cc0',
    mid: '#dddddd',
    high: '#b40426',
    midValue: 4.5,
  ...
  greys: {
    label: 'JOSTER.HeatmapPreset.Greys',
    low: '#ffffff',
    mid: '#969696',
    high: '#000000',
    midValue: 4.5,
  ...
  banded: {
    label: 'JOSTER.HeatmapPreset.Banded',
    low: '#ebece9',
    mid: '#67c44f',
    high: '#054224',
    midValue: 4.5,
