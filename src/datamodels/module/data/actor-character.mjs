...
export default class JosterCharacter extends JosterActorBase {
  ...
  static defineSchema() {
    ...
    schema.abilities = new fields.SchemaField(Object.keys(CONFIG.JOSTER.abilities).reduce((obj, ability) => {
  ...
  prepareDerivedData() {
    ...
    for (const key in this.abilities) {
      ...
      this.abilities[key].label = game.i18n.localize(CONFIG.JOSTER.abilities[key]) ?? key;
    }
  }
